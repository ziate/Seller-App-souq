class ConfigModel {
  ...
  ConfigModel({int systemDefaultCurrency, BaseUrls baseUrls, StaticUrls staticUrls, List<CurrencyList> currencyList, List<Language> languageList, List<ColorList> colors, List<String> unit, String aboutUs,
